# PSOC&trade; Control C1 MCU: GPIO toggle

This code example demonstrates GPIO toggling by periodically blinking an LED using the SysTick timer available in PSOC&trade; Control C1 MCU devices.

[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce242912-gpio-toggle)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[GPIO toggle](https://github.com/Infineon/mtb-example-ce242912-gpio-toggle)" application with the desired name "GPIO toggle" configured for the *KIT_PSC1M3_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC1M3_EVK --app-id mtb-example-ce242912-gpio-toggle --user-app-name GPIO toggle --target-dir "C:/mtb_projects"
   ```
...
3. Confirm that the user LED blinks at approximately 1 Hz.
...
Afterwards, the pin is toggled at a frequency of 1 Hz in the `While(1)` loop. The toggle period can be changed by using `USER_LED_TOGGLE_PERIOD_MS`, which is defined as a global variable.
...
Document title: *CE242912* – *PSOC&trade; Control C1 MCU: GPIO toggle*
